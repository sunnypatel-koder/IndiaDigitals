      ...
      <div className="py-16 px-7 md:px-20 bg-gray-900 flex-col-reverse xl:flex-col flex justify-between xl:relative">
        <div className="flex flex-col">
          <span className="text-2xl md:text-3xl xl:text-4xl font-normal leading-[32px] md:leading-[37px] xl:leading-[45px] py-5">
            ...
            <br /> <span className="text-orange-600">See how we can help.</span>
          </span>
          <a
            href="/basic-detail"
            ...
            <div className="mt-8 grid grid-cols-2 gap-8 lg:mt-0 lg:grid-cols-5 lg:gap-y-16">
              ...
              <div className="col-span-2 lg:col-span-3 lg:flex lg:items-end">
                <form className="w-full">
                  ...
                  <div className="border border-gray-100 p-2 focus-within:border-orange-500/95 sm:flex sm:items-center sm:gap-4 bg-white">
                    <input
                      type="email"
                      id="UserEmail"
                      placeholder="example@gmail.com"
                      className="w-full border-none outline-none sm:text-lg  dark:text-white"
                    />
